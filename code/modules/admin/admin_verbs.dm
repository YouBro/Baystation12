/*admin verb groups - They can overlap if you so wish. Only one of each verb will exist in the verbs list regardless (now in infinity admin_verbs.dm)
...
/client/proc/man_up(mob/T as mob in SSmobs.mob_list)
	...
	to_chat(T, "<span class='notice'><b><font size=3>������ ���&#255; � ���� � ���� ��������.</font></b></span>")
	to_chat(T, "<span class='notice'>����� ������.</span>")
...
/client/proc/global_man_up()
	...
	for (var/mob/T as mob in SSmobs.mob_list)
		to_chat(T, "<br><center><span class='notice'><b><font size=4>������ ���&#255; � ����.<br> ����� ��������.</font></b><br>����� ������.</span></center><br>")
